...
class BaseSVSInfer:
    ...
    def preprocess_word_level_input(self, inp):
        ...
        # #### note: missing phonemes: TH Y IH DH V OY
...
if __name__ == "__main__":
    ...
    for kind in kinds:
        for part in parts:
            ...
            save_path = f"/Netdata/2022/zhouhl/bisinger_mos/system-2/{kind}"
            preprocess_ret_fn = f"/Netdata/2022/zhouhl/bisinger_mos/system-2/{kind}.txt"
